class IGEnhancedBeam extends Effects;
...
var IGEnhancedBeam Next;
var IGEnhancedBeam Free;
...
static final function ResetBeam(IGEnhancedBeam Beam) {
...
static final function IGEnhancedBeam AllocBeam(PlayerPawn P) {
    local IGEnhancedBeam Beam;
    ...
    if (default.Free != none) {
        ...
        Beam = P.Spawn(class'IGEnhancedBeam', P);
    }
...
static final function FreeBeam(IGEnhancedBeam Beam) {
    Beam.bHidden = true;
    Beam.Disable('Tick');
